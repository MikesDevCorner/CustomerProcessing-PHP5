...
//		  und vermutlich zum Erfolg von PHP ma�geblich beigetragen hat. 
//		* Die Zerlegung der Anwendung in Schichten wird vernachl�ssigt. Das f�hrt vermutlich zur Duplizierung
//		  von Code und einer enormen Steigerung von Komplexit�t, wenn es zur Erweiterung der Anwendung kommt.
...
class HTTPRequest implements IRequest {
	...
	public function __construct($method="POST") {
		...
		//Falls �ber die Get-Methode der Parameter "JSON" gesetzt ist,
		...
		//Der else-Fall tritt ein, wenn der Request ganz normal �ber ein
		//Form-Submit oder �hnlich gemacht wird. Auch in diesem Fall kann es
		//sich um einen AJAX-Request handeln. Er ist aber nicht im JSON-Format �bergeben.
		else {
	...
	//mit dem Namen nonajax mitzu�bergeben. Das passiert in der cmdLogin.php
