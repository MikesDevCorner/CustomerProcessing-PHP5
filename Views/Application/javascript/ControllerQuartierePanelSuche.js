Application.ControllerQuartierePanelSuche = function()
{
    this.tmpComponent;
    ...
    this.SetListeners = function()
    {
        ...
        Ext.getCmp('btn_suchkriterien_go').on('click', function() {
            ...
            var lastOptions = Ext.getCmp('quartiereauswahl').getStore().lastOptions;
            Ext.apply(lastOptions.params, {
                start: 0
            });
            Ext.getCmp('quartiereauswahl').getStore().reload(lastOptions);
        });
    }
}