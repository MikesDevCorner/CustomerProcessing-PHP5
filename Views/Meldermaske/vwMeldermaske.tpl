...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><?php print $this->title.' '.$this->version; ?> - Anfrage Meldermaske</title>
                <link rel="stylesheet" href="Views/Meldermaske/css/style.css" type="text/css" media="screen"/>
                <!--[if IE 6]><link rel="stylesheet" href="Views/Meldermaske/css/style.ie6.css" type="text/css" media="screen" /><![endif]-->
				<!--[if IE 7]><link rel="stylesheet" href="Views/Meldermaske/css/style.ie7.css" type="text/css" media="screen" /><![endif]-->
                ...
                <link rel="stylesheet" type="text/css" href="Views/Meldermaske/css/meldermaske.css"/>
		...
		<!--<script type="text/javascript" src="Views/Meldermaske/javascript/jquery.js"></script>-->
		<!--<script type="text/javascript" src="Views/Meldermaske/javascript/script.js"></script>-->
		<!--<script type="text/javascript" src="Resources/ext3/src/shared/examples.js"></script>-->
		<script type="text/javascript" src="Views/Meldermaske/javascript/meldermaske.js"></script>
	</head>
	<body>
		<div id="art-main">
			<div class="art-sheet">
