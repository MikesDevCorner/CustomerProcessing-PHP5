Application.ControllerKatalogbezieherPanelSuche = function()
{
    this.tmpComponent;
    ...
    this.SetListeners = function()
    {
        ...
        Ext.getCmp('btn_suchkriterien_go').on('click', function() {
            ...
            var lastOptions = Ext.getCmp('katalogbezieherauswahl').getStore().lastOptions;
            Ext.apply(lastOptions.params, {
                start: 0
            });
            Ext.getCmp('katalogbezieherauswahl').getStore().reload(lastOptions);
        });
    }
}