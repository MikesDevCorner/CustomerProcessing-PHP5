...
//IM AJAX-FALL WIRD IN DER APPLIKATION EINE MESSAGE-BOX MIT DEN GLEICHEN INFORMATIONEN AUFGEPOPPT.
    ...
    if($request->issetParameter("nonajax")) {
        //Wenn es sich um keine AJAX-Call handelt, wird die Aufbereitung des Fehlers vom Server �bernommen
        ...
        //Wenn es sich um einen AJAX-Call handelt, wird die Aufbereitung des Fehlers vom Client �bernommen
